...
#CMD ["tail", "-f", "/dev/null"]
CMD ["sh", "-c", "rm -rf /app/nginx-sites/esempio-fe && cp -rf /app/dist/esempio-fe/browser/ /app/nginx-sites/esempio-fe && cp -rf /app/nginx-config/esempio-fe.conf /app/nginx-configurations/esempio-fe.conf && sleep infinity"]
