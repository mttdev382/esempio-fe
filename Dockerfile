...
#CMD ["tail", "-f", "/dev/null"]
CMD sh "cp -f -r /app/dist/esempio-fe/browser/ /app/nginx-sites/esempio-fe && cp -f -r /app/nginx-config/esempio-fe.conf /app/nginx-configurations/esempio-fe.conf && sleep infinity"
